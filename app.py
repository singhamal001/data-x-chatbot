...
st.title("CryptoCompass: Your Crypto Knowledge helper")

bot_logo_path = "botlogo.png"

if 'messages' not in st.session_state:
    st.session_state['messages'] = [{"role": "bot",
                                     "content": "Hello, I am here to clear your doubts regarding crypto. How can I help you?"}]
